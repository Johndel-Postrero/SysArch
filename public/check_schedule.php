...
try {
    ...
    foreach ($labs_to_check as $lab) {
        if ($schedule_type === 'recurring') {
            ...
            $stmt->bind_param("ssssssss", $lab, $weekday, $end_time, $start_time, $end_time, $start_time, $start_time, $end_time);
        } else {
            $sql = "SELECT id, lab_number, 
                    TIME_FORMAT(start_time, '%H:%i') as start_time, 
                    TIME_FORMAT(end_time, '%H:%i') as end_time,
            ...
            $stmt = $conn->prepare($sql);
            $stmt->bind_param("ssssssss", $lab, $specific_date, $end_time, $start_time, $end_time, $start_time, $start_time, $end_time);
        }

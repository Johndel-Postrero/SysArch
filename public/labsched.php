    ...
    <div class="flex h-screen">
            ...
            <div class="flex-1 p-6 flex flex-col">
                <div class="w-full max-w-6xl mx-auto">
                    ...
                    <div class="schedule-container">
                        <!-- Add Schedule Form -->
                        <div class="schedule-form bg-white p-6 rounded-lg shadow">
                            <h2 class="text-xl font-semibold mb-4">Add New Schedule</h2>
                            <form id="scheduleForm" method="POST" onsubmit="return validateScheduleForm(event)">
                                <div class="space-y-4">
                                    <div>
                                        <label for="lab_number" class="block text-sm font-medium text-gray-700">Lab Number</label>
                                        <select id="lab_number" name="lab_number" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-[#002044] focus:border-[#002044]" required>
                                    ...
                                    <div id="recurringFields">
                                        ...
                                        <select id="weekday" name="weekday" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-[#002044] focus:border-[#002044]" required>
       ...
       value="<?php echo date('Y-m-d'); ?>"> <!-- Add default value -->
                                    ...
                                    <div>
                                        ...
                                        <select id="status" name="status" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-[#002044] focus:border-[#002044]" required>
                                    ...
                                    <div>
                                        ...
                                        <textarea id="reason" name="reason" rows="2" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-[#002044] focus:border-[#002044]"></textarea>
                                    </div>
                                    <div>
                                        <button type="submit" class="w-full bg-[#002044] text-white py-2 px-4 rounded-md hover:bg-[#003366] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#002044]">
                                            Add Schedule
                                        </button>
                                    </div>
                                </div>
                                <input type="hidden" id="conflict_ids" name="conflict_ids" value="">
                            </form>
                        </div>
